...
<section class="row">
    <div class="col-md-6">
        <form action="<?= BASE_URL . 'mahasiswa/store' ?>" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
                <label for="edtNim" class="col-sm-2 col-form-label">NIM</label>
                <div class="col-sm-10">
                    <input type="text" id="edtNim" class="form-control" name="nim" value="<?= FlashData::getMessage('nim') ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <label for="edtNama" class="col-sm-2 col-form-label">Nama</label>
                <div class="col-sm-10">
                    <input type="text" id="edtNama" class="form-control" name="nama" value="<?= FlashData::getMessage('nama') ?>" required>
                </div>
            </div>
            <div class="row mb-3">
